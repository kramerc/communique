...
// Based on:
// https://raw.githubusercontent.com/thelounge/thelounge/master/server/types/modules/irc-framework.d.ts
...
declare module "irc-framework" {
  ...
  export class Client extends EventEmitter {
    ...
    connect(connect_options?: ConnectOpts): void;
    ...
    on(
      eventType: "quit" | "part" | "kick",
      cb: (event: QuitEventArgs) => void
    ): this;
    ...
    on(
      eventType: "notice",
      cb: (event: MessageEventArgs /* TODO */) => any
    ): this;

    on(eventType: "mode", cb: (event: ModeEventArgs) => any): this;

    on(
      eventType: "socket close" | "socket connected" | "raw socket connected",
      cb: (event: Record<string, unknown>) => any
    ): this;

    on(
      eventType: "server options",
      cb: (event: ServerOptionsEventArgs) => any
    ): this;
    ...
    on(
      eventType: "nick invalid",
      cb: (event: NickInvalidEventArgs) => any
    ): this;
  ...
  class IrcChannel extends EventEmitter {
    ...
    on(
      eventType: "channel info",
      cb: (event: ChannelInfoEventArgs) => any
    ): this;
